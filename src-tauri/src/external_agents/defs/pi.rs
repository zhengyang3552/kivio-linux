...
pub const PI_AGENT_DEF: RuntimeAgentDef = RuntimeAgentDef {
    ...
    model_probe: Some(super::super::types::ModelProbeStrategy::PiRpc),
    model_probe_args: None,
    current_config: super::super::types::CurrentConfigStrategy::Pi,
    provider_profile: super::super::types::ProviderProfileStrategy::Pi,
    ...
    error_policy: super::super::types::AgentErrorPolicy::login("pi"),
    ...
    install: super::super::types::AgentInstallSpec {
        ...
        script_unix: None,
        script_windows: None,
        update: super::super::types::UpdateStrategy::Command(&["update", "--self"]),
    ...
    run: super::super::types::AgentRunPolicy {
        regenerate: super::super::types::RegenerateStrategy::PiRpc,
