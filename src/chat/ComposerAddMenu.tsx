...
import { FolderPlus, Folders, Paperclip, Plus, X } from 'lucide-react'
...
export function ComposerAddMenu({
  ...
  const active = directories.length > 0
  ...
  return (
    <div ref={ref} className="relative shrink-0">
      ...
      {openMenu && (
        <div
          ref={popoverRef}
          className={`chat-motion-popover chat-popover-scroll absolute left-0 z-50 w-[min(260px,calc(100vw-24px))] overflow-y-auto kv-menu ${placement}`}
